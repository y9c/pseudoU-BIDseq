...
RUN pip install --no-cache-dir snakemake==7.16 panoptes-ui pysam pyfaidx scipy parasail git+https://github.com/y9c/MultiQC_YC.git git+https://github.com/marcelm/cutadapt.git
# install umicollapse
